...
$result = mysql_query("select * from gm");
?>
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <aside class="right-side">                
                ...
                <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">GM Details</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        ?>
                                        <tr>
                                        <td><?php echo $arr['gmid'];?></td>
                                        <td><?php echo $arr['town'];?></td>
                                        <td><?php echo $arr['spot'];?></td>
                                        <td><?php echo $arr['total'];?></td>
                                        <td><a  href="delgm.php?gmid=<?php echo $arr['gmid'];?>">Delete GM</a></td> 
                                        </tr>
                                        <?php
                                        }
                                        ?>                                            
