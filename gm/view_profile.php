...
$id2=$_SESSION['user'];
$result=mysql_query("SELECT * FROM register WHERE username ='$id2'");
$details=mysql_query("SELECT * FROM gm WHERE gmid ='$id2'");
$data=mysql_fetch_array($result);
$spotdet=mysql_fetch_array($details)
?>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $spotdet['spot']?>" disabled>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    <div class="form-group" >
                                        <label>Town:</label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $spotdet['town']?>" disabled>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
