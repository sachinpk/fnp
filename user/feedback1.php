...
if(@sizeof($blankArray)>0)
{
 $message0="<div class='alert alert-danger alert-dismissable'>
    ...
    <b>Alert!</b> Fill all fields
</div>";
}
if($message0=="")
{

$insert=mysql_query("insert into feedback (name,subject,email,description)values('".$_POST['name']."','".$_POST['sub']."','".$_POST['email']."','".$_POST['det']."')");

// $sel=mysql_query("select max(no) from sentitems");
// $s=mysql_fetch_array($sel);
// $b=$s[0];
// $b=$b+$a;
// $insert=mysql_query("insert into sentitems (no.,to,details)values('$b','admin','".$_POST['det']."')");
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <h2 class="page-header">Select City to park</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-danger">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <textarea name="det" id="email_message" class="form-control" placeholder="Message" style="height: 120px;"></textarea>
                                    </div>
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                                    <button type="submit" value="send" name="finishbutton" class="btn btn-primary"><i class="fa fa-envelope"></i> Send Message</button>
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class='alert alert-success alert-dismissable'>
                                        ...
                                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                                        <b>Alert!</b> Feedback sent Successfully
                                    </div>
