...
$from=$_POST['from'];
$to=$_POST['to'];
$select1=mysql_query("select * from mapping where no='$from'");
$fromtime1=mysql_fetch_array($select1,MYSQL_ASSOC);
$fromtime=$fromtime1['tm'];
$select2=mysql_query("select * from mapping where no='$to'");
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <h2 class="page-header">Block A Space</h2>
                            ...
                            <div class="box box-danger">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vehicleno" class="form-control"placeholder="Vehicle No">
                                    </div>
                                    <div class="form-group">
                                        <label>Account Pin:</label>
                                        <input type="text" name="accpin" class="form-control"placeholder="Account Pin">
                                    </div>
                                    <div class="form-group">
                                        <label>Account Sl No:</label>
                                        <input type="text" name="accsl" class="form-control"placeholder="Account Sl No">
                                    </div>
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                                    <input type="submit" value="Block Space" name="finishbutton" class="btn btn-primary">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    <div class="callout callout-info">
                                        <h4>Projected Price</h4>
                                        <p><h1><i class="fa fa-inr"><?php echo $price;?></i></h1></p>
                                    </div>
                    ...
                    <input name="spot" type="hidden" value="<?php echo $spot;?>">
