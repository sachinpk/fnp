...
$sel=mysql_query("select * from mapping");
$totime=mysql_query("select * from mapping where no>0");
?>
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <h2 class="page-header">Block A Space</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-danger">
                                ...
                                <div class="box-body">
                                    <div id="from" class="form-group">
                                        <label>From:</label>
                                        <select id="fromvalue" name="from" class="form-control">
                                        <?php
                                          while($no=mysql_fetch_array($sel))
                                          {
                                          $no1=$no['tm'];
                                          $count=$no['no']?>
                                          <option value="<?php echo $count;?>" ><?php echo $no1;?></option>
                                          <?php
                                          }
                                        ?> 
                                        </select>
                                    </div>
                                    <div id="to_time" class="form-group">
                                        <label id="to_label">To:</label>
                                        <select id="tovalue" name="to" class="form-control">
                                         <?php
                                          while($to=mysql_fetch_array($totime))
                                          {
                                          $no1=$to['tm'];
                                          $count=$to['no']?>
                                          <option value="<?php echo $count;?>" ><?php echo $no1;?></option>
                                ...
                                <div class="box-footer">
                                    <input type="submit" value="Calculate Price" name="submit" class="btn btn-primary">
        ...
        <script type="text/javascript">
            ...
            $("#tovalue").change(function () {

                var to = parseInt($(this).val());
                var from = parseInt($("#fromvalue").val());
                $("#to_time").prop('class',"form-group");
                $("#to_label").html('To:');
                if (from>=to) {
                    $("#to_time").prop('class',"form-group has-error");
                    $("#to_label").html('<i class="fa fa-times-circle-o"></i> To: Wrong time selection');};  
            }); 
        </script>
        <script type="text/javascript">
